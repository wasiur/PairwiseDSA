...
write.csv(posterior_samples, file="plots/AH1N1/AH1N1_DSA_posterior_samples.csv")
...
ggsave(ah1n1_fitted_cumulative, filename = "plots/AH1N1/small/AH1N1_fitted_cumulative_cases", device="pdf", width = 6, height = 4)
...
AH1N1_fitted_daily
ggsave(AH1N1_fitted_daily, filename = "plots/AH1N1/small/AH1N1_fitted_daily_cases", device="pdf", width = 6, height = 4)
...
R0_plot<-ggplot(posterior_samples, aes(x=R0)) + 
  ...
  theme_classic()
R0_plot
ggsave("plots/AH1N1/AH1N1_R0_histogram.pdf", plot=R0_plot, device="pdf", width = 6, height = 4)
...
gamma_plot<-ggplot(posterior_samples, aes(x=gamma)) + 
  ...
  theme_classic()
gamma_plot
ggsave("plots/AH1N1/AH1N1_gamma_histogram.pdf", plot=gamma_plot, device="pdf", width = 6, height = 4)
...
tau_plot<-ggplot(posterior_samples, aes(x=tau)) + 
  ...
  theme_classic()
tau_plot
ggsave("plots/AH1N1/AH1N1_tau_histogram.pdf", plot=tau_plot, device="pdf", width = 6, height = 4)
...
rho_plot<-ggplot(posterior_samples, aes(x=rho)) + 
  ...
  theme_classic()
rho_plot
ggsave("plots/AH1N1/AH1N1_rho_histogram.pdf", plot=rho_plot, device="pdf", width = 6, height = 4)
...
n_plot<-ggplot(posterior_samples, aes(x=n)) + 
  ...
  theme_classic()
n_plot
ggsave("plots/AH1N1/AH1N1_n_histogram.pdf", plot=n_plot, device="pdf", width = 6, height = 4)
...
deg_plot<-ggplot(posterior_samples, aes(x=deg)) + 
  ...
  theme_classic()
deg_plot
ggsave("plots/AH1N1/AH1N1_deg_histogram.pdf", plot=deg_plot, device="pdf", width = 6, height = 4)
...
a_plot<-ggplot(posterior_samples, aes(x=a)) + 
  ...
  theme_classic()
a_plot
ggsave("plots/AH1N1/AH1N1_a_histogram.pdf", plot=a_plot, device="pdf", width = 6, height = 4)
...
b_plot<-ggplot(posterior_samples, aes(x=b)) + 
  ...
  theme_classic()
b_plot
ggsave("plots/AH1N1/AH1N1_b_histogram.pdf", plot=b_plot, device="pdf", width = 6, height = 4)
...
xi_plot<-ggplot(posterior_samples, aes(x=xi)) + 
  ...
  theme_classic()
xi_plot
ggsave("plots/AH1N1/AH1N1_xi_histogram.pdf", plot=xi_plot, device="pdf", width = 6, height = 4)

tau_deg_scatter <- ggplot(posterior_samples, aes(x=deg, y=tau)) + geom_point(alpha=0.25, col=1, size=5)+
  labs(x="Degree", y = "Infection rate") + theme_classic()
tau_deg_scatter
ggsave("plots/AH1N1/AH1N1_tau_deg_scatter.pdf", plot=tau_deg_scatter, device="pdf", width = 6, height = 4)


ab_scatter <- ggplot(posterior_samples, aes(x=a, y=b)) + geom_point(alpha=0.25, col=1, size=5)+
  labs(x="a", y = "b") + theme_classic()
ab_scatter
ggsave("plots/AH1N1/AH1N1_ab_scatter.pdf", plot=ab_scatter, device="pdf", width = 6, height = 4)
...
tau_traceplot <- traceplot(fit, "tau")
tau_traceplot
ggsave("plots/AH1N1/AH1N1_tau_traceplot.pdf", plot=tau_traceplot, device="pdf", width = 6, height = 4)

gamma_traceplot <- traceplot(fit, "gamma")
gamma_traceplot
ggsave("plots/AH1N1/AH1N1_gamma_traceplot.pdf", plot=gamma_traceplot, device="pdf", width = 6, height = 4)

R0_traceplot <- traceplot(fit, "R0")
R0_traceplot
ggsave("plots/AH1N1/AH1N1_R0_traceplot.pdf", plot=R0_traceplot, device="pdf", width = 6, height = 4)

xi_traceplot <- traceplot(fit, "xi")
xi_traceplot
ggsave("plots/AH1N1/AH1N1_xi_traceplot.pdf", plot=xi_traceplot, device="pdf", width = 6, height = 4)


deg_traceplot <- traceplot(fit, "deg")
deg_traceplot
ggsave("plots/AH1N1/AH1N1_deg_traceplot.pdf", plot=deg_traceplot, device="pdf", width = 6, height = 4)
...
I0_plot<-ggplot(posterior_samples, aes(x=I0)) + 
  ...
  theme_classic()
I0_plot
ggsave("plots/AH1N1/AH1N1_I0_histogram.pdf", plot=I0_plot, device="pdf", width = 6, height = 4)
...
Eff_popsize_plot<-ggplot(posterior_samples, aes(x=effective_population_size)) + 
  ...
  theme_classic()
Eff_popsize_plot
ggsave("plots/AH1N1/AH1N1_Effective_popsize_histogram.pdf", plot=Eff_popsize_plot, device="pdf", width = 6, height = 4)
...
Total_popsize_plot<-ggplot(posterior_samples, aes(x=total_population_size)) + 
  ...
  theme_classic()
Total_popsize_plot
ggsave("plots/AH1N1/AH1N1_Total_popsize_histogram.pdf", plot=Total_popsize_plot, device="pdf", width = 6, height = 4)
...
ah1n1_fitted_cumulative
ggsave(ah1n1_fitted_cumulative, filename = "plots/AH1N1/AH1N1_fitted_cumulative_cases", device="pdf", width = 6, height = 4)
...
AH1N1_fitted_daily
ggsave(AH1N1_fitted_daily, filename = "plots/AH1N1/AH1N1_fitted_daily_cases", device="pdf", width = 6, height = 4)


write.csv(fitted_cum_curves, "plots/AH1N1/AH1N1_fitted_cum_cases.csv")
write.csv(fitted_daily, "plots/AH1N1/AH1N1_fitted_daily_cases.csv")
